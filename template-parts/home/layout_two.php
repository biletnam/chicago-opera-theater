  ...
  <div class="tile is-vertical">
    ...
    <div class="tile">
      <div class="tile is-parent">
        <div class="tile is-child">
          <div class="card">
            <?php if (! empty($preview_set['bottom_left_header'])): ?>
              <header class="card-header">
                <h4 class="card-header-title"><?php echo $preview_set['bottom_left_header']; ?></h4>
              </header>
            <?php endif; ?>
            <div class="card-content content">
              <?php echo $preview_set['bottom_left_content']; ?>
            </div>
            <?php if (! empty($preview_set['bottom_left_footer'])): ?>
              <footer class="card-footer">
                <div class="card-footer-item">
                  <a class="has-arrow-icon" href="<?php echo $preview_set['bottom_left_footer']; ?>">
                    <span>Read more</span>
                    <span class="icon"><i class="fa fa-arrow-right"></i></span>
                  </a>
                </div>
      ...
      <div class="tile is-parent">
        <div class="tile is-child">
          <div class="card">
            <?php if (! empty($preview_set['bottom_right_header'])): ?>
              <header class="card-header">
                <h4 class="card-header-title"><?php echo $preview_set['bottom_right_header']; ?></h4>
              </header>
            <?php endif; ?>
            <div class="card-content content">
              <?php echo $preview_set['bottom_right_content']; ?>
            </div>
            <?php if (! empty($preview_set['bottom_right_footer'])): ?>
              <footer class="card-footer">
                <div class="card-footer-item">
                  <a class="has-arrow-icon" href="<?php echo $preview_set['bottom_right_footer']; ?>">
                    <span>Read more</span>
                    <span class="icon"><i class="fa fa-arrow-right"></i></span>
                  </a>
                </div>
