...
function send_cot_subscription_notification($params, $refID) {
  ...
  $message .= "==========================================\n";
  $message .= "\n";
  $message .= 'Subscription Name: ' . $params['customer']['subscriber_salutation'] . ' ' . $params['customer']['subscriber_name'] . "\n";
  ...
  $message .= 'Address: ' . $params['customer']['billing']['address'] . ' ' . $params['customer']['billing']['address_2'] . "\n";
  ...
  $message .= 'Address: ' . $params['customer']['shipping']['address'] . ' ' . $params['customer']['shipping']['address_2'] . "\n";
